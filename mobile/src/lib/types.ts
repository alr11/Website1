/**
 * Hand-written mirror of the SQL in `supabase/migrations/` at the repo root.
 * Shared shape with the web app — same database, same row types.
 *
...
export type Database = {
  public: {
    ...
    Functions: {
      /** Deletes the caller's account and every row they own. */
      delete_own_account: {
